...
class _LoginIslemleriState extends State<LoginIslemleri> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Login İşlemleri Demo"),
      ),
      body: Center(
        child: Column(
          children: [
  ...
  void _emailSifreKullaniciOlustur() async {
    String _email = "yeniturkalpaslan4@gmail.com";
  ...
  void _updatePassword() async {
    try {
      ...
      try {
        ...
        String email = 'yeniturkalpaslan4@gmail.com';
  ...
  void _updateEmail() async {
    try {
      await _auth.currentUser.updateEmail("yeniturkalpaslan4@gmail.com");
      ...
      try {
        ...
        //güncel email ve şifre bilgisi dogruysa eski şifresi yenisiyle güncellenir.
        debugPrint("Girilen eski email şifre bilgisi dogru");
        await _auth.currentUser.updateEmail("alp@alp.com");
